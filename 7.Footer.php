...
<body>
    <footer>
        <div class="footer-top">
            ...
            <p>Request blood or donate today to save lives!</p>
            <div class="footer-buttons">
                <a href="3.Request.php" class="footer-button">Request Blood</a>
                <a href="4.Donate.php" class="footer-button">Donate Blood</a>
            </div>
        </div>
        <div class="lower_sec">
            <div class="footer-middle">
                <div class="footer-left">
                    ...
                    <p class="slogan">Together, We Save Lives</p>
                </div>
                <div class="footer-center">
                    <h4>Contact Us</h4>
                    <p>Address: Sanepa, Lalitpur, Nepal</p>
                    <p>Email: sath@gmail.com</p>
                    <p>Phone: 01 98765432</p>
                </div>
